# S2 Prompt — 트랙 ② Ephys Foundation Model
...
상단 제목 (32pt Bold #003380): "② 전기생리 파운데이션 모델"
부제 (22pt #0072B2): "밀리초 단위 신경 활동, 종을 넘는 통합 모델"

좌측 60% — 번호 카드 3개를 위에서 아래로 배치, 카드 사이 짧은 수직 직선 화살표:
- 카드 1 (#EDF6FC 채움, #003380 얇은 테두리): 파형 신호 아이콘(flat line). 제목 "다중 신호 데이터" (18pt Bold #003380). 본문 "스파이크 · LFP · EEG · iEEG (여러 종)" (16pt #282945)
- 카드 2: 통합 블록 아이콘. 제목 "DIVER 통합 모델" (18pt Bold). 본문 "여러 채널·과제를 하나로 학습" (16pt)
- 카드 3: 말풍선 아이콘. 제목 "뇌–기계 인터페이스 비전" (18pt Bold). 본문 "신경 활동을 자연어 추론으로 (도전 로드맵)" (16pt)

우측 40% 상단 — 큰 핵심 수치 (32pt Bold #E69F00): "밀리초" / 그 아래 캡션 (12pt #5A5A6E): "세포 단위 시간 해상도"

우측 40% 하단 — #EDF6FC 박스: 작은 제목 "Lab 연구" (18pt Bold #003380), 본문 "DIVER-1 · EEG×DIVER · LBM×Qualia" (16pt #282945)
...
## Self-Validation
단어수 ≤400 ✓ · 색상 5 (white/navy/orange/teal/ice) ✓ · 아이콘 3 ✓ · 복잡도 LOW ✓ · 메시지 1개(Ephys FM) ✓
