...
const features = [
  ...
  },
  {
    ...
    description: 'Build the lab\'s own Brain Foundation Models across three tracks — fMRI (SwiFT V2, NeuroMamba, MBBN), electrophysiology (DIVER-1), and continuous neural fields (OmniField, ICLR 2026) — and the compound/agentic AI that orchestrates them into an "AI Scientist for Brain".',
    descriptionKorean: 'lab 자체 Brain Foundation Model을 세 트랙으로 구축합니다 — fMRI(SwiFT V2·NeuroMamba·MBBN), 전기생리(DIVER-1), 연속 신경장(OmniField, ICLR 2026) — 그리고 이들을 묶어 "AI Scientist for Brain"으로 만드는 compound/agentic AI.',
    highlights: ['3개 Brain FM 트랙', 'compound/agentic AI', 'AI Scientist for Brain'],
